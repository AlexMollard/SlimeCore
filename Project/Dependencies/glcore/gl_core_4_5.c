...
void (CODEGEN_FUNCPTR* _ptrc_glBindTextureUnit)(GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glBlitNamedFramebuffer)(GLuint, GLuint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum) = NULL;
GLenum(CODEGEN_FUNCPTR* _ptrc_glCheckNamedFramebufferStatus)(GLuint, GLenum) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedBufferData)(GLuint, GLenum, GLenum, GLenum, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedBufferSubData)(GLuint, GLenum, GLintptr, GLsizei, GLenum, GLenum, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedFramebufferfi)(GLuint, GLenum, const GLfloat, GLint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedFramebufferfv)(GLuint, GLenum, GLint, const GLfloat*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedFramebufferiv)(GLuint, GLenum, GLint, const GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClearNamedFramebufferuiv)(GLuint, GLenum, GLint, const GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glClipControl)(GLenum, GLenum) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCompressedTextureSubImage1D)(GLuint, GLint, GLint, GLsizei, GLenum, GLsizei, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCompressedTextureSubImage2D)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCompressedTextureSubImage3D)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCopyNamedBufferSubData)(GLuint, GLuint, GLintptr, GLintptr, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCopyTextureSubImage1D)(GLuint, GLint, GLint, GLint, GLint, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCopyTextureSubImage2D)(GLuint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCopyTextureSubImage3D)(GLuint, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateBuffers)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateFramebuffers)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateProgramPipelines)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateQueries)(GLenum, GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateRenderbuffers)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateSamplers)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateTextures)(GLenum, GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateTransformFeedbacks)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glCreateVertexArrays)(GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glDisableVertexArrayAttrib)(GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glEnableVertexArrayAttrib)(GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glFlushMappedNamedBufferRange)(GLuint, GLintptr, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGenerateTextureMipmap)(GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetCompressedTextureImage)(GLuint, GLint, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetCompressedTextureSubImage)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLsizei, void*) = NULL;
GLenum(CODEGEN_FUNCPTR* _ptrc_glGetGraphicsResetStatus)() = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedBufferParameteri64v)(GLuint, GLenum, GLint64*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedBufferParameteriv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedBufferPointerv)(GLuint, GLenum, void**) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedBufferSubData)(GLuint, GLintptr, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedFramebufferAttachmentParameteriv)(GLuint, GLenum, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedFramebufferParameteriv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetNamedRenderbufferParameteriv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetQueryBufferObjecti64v)(GLuint, GLuint, GLenum, GLintptr) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetQueryBufferObjectiv)(GLuint, GLuint, GLenum, GLintptr) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetQueryBufferObjectui64v)(GLuint, GLuint, GLenum, GLintptr) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetQueryBufferObjectuiv)(GLuint, GLuint, GLenum, GLintptr) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureImage)(GLuint, GLint, GLenum, GLenum, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureLevelParameterfv)(GLuint, GLint, GLenum, GLfloat*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureLevelParameteriv)(GLuint, GLint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureParameterIiv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureParameterIuiv)(GLuint, GLenum, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureParameterfv)(GLuint, GLenum, GLfloat*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureParameteriv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTextureSubImage)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTransformFeedbacki64_v)(GLuint, GLenum, GLuint, GLint64*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTransformFeedbacki_v)(GLuint, GLenum, GLuint, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetTransformFeedbackiv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetVertexArrayIndexed64iv)(GLuint, GLuint, GLenum, GLint64*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetVertexArrayIndexediv)(GLuint, GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetVertexArrayiv)(GLuint, GLenum, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnCompressedTexImage)(GLenum, GLint, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnTexImage)(GLenum, GLint, GLenum, GLenum, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnUniformdv)(GLuint, GLint, GLsizei, GLdouble*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnUniformfv)(GLuint, GLint, GLsizei, GLfloat*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnUniformiv)(GLuint, GLint, GLsizei, GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glGetnUniformuiv)(GLuint, GLint, GLsizei, GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glInvalidateNamedFramebufferData)(GLuint, GLsizei, const GLenum*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glInvalidateNamedFramebufferSubData)(GLuint, GLsizei, const GLenum*, GLint, GLint, GLsizei, GLsizei) = NULL;
void* (CODEGEN_FUNCPTR* _ptrc_glMapNamedBuffer)(GLuint, GLenum) = NULL;
void* (CODEGEN_FUNCPTR* _ptrc_glMapNamedBufferRange)(GLuint, GLintptr, GLsizei, GLbitfield) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glMemoryBarrierByRegion)(GLbitfield) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedBufferData)(GLuint, GLsizei, const void*, GLenum) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedBufferStorage)(GLuint, GLsizei, const void*, GLbitfield) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedBufferSubData)(GLuint, GLintptr, GLsizei, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferDrawBuffer)(GLuint, GLenum) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferDrawBuffers)(GLuint, GLsizei, const GLenum*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferParameteri)(GLuint, GLenum, GLint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferReadBuffer)(GLuint, GLenum) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferRenderbuffer)(GLuint, GLenum, GLenum, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferTexture)(GLuint, GLenum, GLuint, GLint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedFramebufferTextureLayer)(GLuint, GLenum, GLuint, GLint, GLint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedRenderbufferStorage)(GLuint, GLenum, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glNamedRenderbufferStorageMultisample)(GLuint, GLsizei, GLenum, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glReadnPixels)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureBarrier)() = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureBuffer)(GLuint, GLenum, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureBufferRange)(GLuint, GLenum, GLuint, GLintptr, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameterIiv)(GLuint, GLenum, const GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameterIuiv)(GLuint, GLenum, const GLuint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameterf)(GLuint, GLenum, GLfloat) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameterfv)(GLuint, GLenum, const GLfloat*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameteri)(GLuint, GLenum, GLint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureParameteriv)(GLuint, GLenum, const GLint*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureStorage1D)(GLuint, GLsizei, GLenum, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureStorage2D)(GLuint, GLsizei, GLenum, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureStorage2DMultisample)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLboolean) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureStorage3D)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureStorage3DMultisample)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureSubImage1D)(GLuint, GLint, GLint, GLsizei, GLenum, GLenum, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureSubImage2D)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTextureSubImage3D)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void*) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTransformFeedbackBufferBase)(GLuint, GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glTransformFeedbackBufferRange)(GLuint, GLuint, GLuint, GLintptr, GLsizei) = NULL;
GLboolean(CODEGEN_FUNCPTR* _ptrc_glUnmapNamedBuffer)(GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayAttribBinding)(GLuint, GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayAttribFormat)(GLuint, GLuint, GLint, GLenum, GLboolean, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayAttribIFormat)(GLuint, GLuint, GLint, GLenum, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayAttribLFormat)(GLuint, GLuint, GLint, GLenum, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayBindingDivisor)(GLuint, GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayElementBuffer)(GLuint, GLuint) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayVertexBuffer)(GLuint, GLuint, GLuint, GLintptr, GLsizei) = NULL;
void (CODEGEN_FUNCPTR* _ptrc_glVertexArrayVertexBuffers)(GLuint, GLuint, GLsizei, const GLuint*, const GLintptr*, const GLsizei*) = NULL;

static int Load_Version_4_5()
{
	int numFailed = 0;
	...
	_ptrc_glClearNamedBufferSubData = (void (CODEGEN_FUNCPTR*)(GLuint, GLenum, GLintptr, GLsizei, GLenum, GLenum, const void*))IntGetProcAddress("glClearNamedBufferSubData");
	...
	_ptrc_glCopyNamedBufferSubData = (void (CODEGEN_FUNCPTR*)(GLuint, GLuint, GLintptr, GLintptr, GLsizei))IntGetProcAddress("glCopyNamedBufferSubData");
	...
	_ptrc_glFlushMappedNamedBufferRange = (void (CODEGEN_FUNCPTR*)(GLuint, GLintptr, GLsizei))IntGetProcAddress("glFlushMappedNamedBufferRange");
	...
	_ptrc_glGetGraphicsResetStatus = (GLenum(CODEGEN_FUNCPTR*)())IntGetProcAddress("glGetGraphicsResetStatus");
	...
	_ptrc_glGetNamedBufferSubData = (void (CODEGEN_FUNCPTR*)(GLuint, GLintptr, GLsizei, void*))IntGetProcAddress("glGetNamedBufferSubData");
	...
	_ptrc_glMapNamedBufferRange = (void* (CODEGEN_FUNCPTR*)(GLuint, GLintptr, GLsizei, GLbitfield))IntGetProcAddress("glMapNamedBufferRange");
	...
	_ptrc_glNamedBufferData = (void (CODEGEN_FUNCPTR*)(GLuint, GLsizei, const void*, GLenum))IntGetProcAddress("glNamedBufferData");
	if (!_ptrc_glNamedBufferData) numFailed++;
	_ptrc_glNamedBufferStorage = (void (CODEGEN_FUNCPTR*)(GLuint, GLsizei, const void*, GLbitfield))IntGetProcAddress("glNamedBufferStorage");
	if (!_ptrc_glNamedBufferStorage) numFailed++;
	_ptrc_glNamedBufferSubData = (void (CODEGEN_FUNCPTR*)(GLuint, GLintptr, GLsizei, const void*))IntGetProcAddress("glNamedBufferSubData");
	...
	_ptrc_glTextureBarrier = (void (CODEGEN_FUNCPTR*)())IntGetProcAddress("glTextureBarrier");
	...
	_ptrc_glTextureBufferRange = (void (CODEGEN_FUNCPTR*)(GLuint, GLenum, GLuint, GLintptr, GLsizei))IntGetProcAddress("glTextureBufferRange");
	...
	_ptrc_glTransformFeedbackBufferRange = (void (CODEGEN_FUNCPTR*)(GLuint, GLuint, GLuint, GLintptr, GLsizei))IntGetProcAddress("glTransformFeedbackBufferRange");
...
int ogl_IsVersionGEQ(int majorVersion, int minorVersion)
{
	...
	if (g_major_version > majorVersion) return 1;
	if (g_major_version < majorVersion) return 0;
